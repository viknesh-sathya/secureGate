    ...
    >
      <div className="p-6 sm:p-8">
        ...
        <form onSubmit={handleSignUp}>
          ...
          >
            {isLoading ? (
              <Loader className="w-6 h-6 mx-auto animate-[spin_2s_linear_infinite]" />
            ) : (
              "Sign Up"
            )}
          </motion.button>
      ...
      <div className="px-6 py-4 bg-gray-900/50 flex flex-col items-center justify-between text-[11px] sm:text-sm whitespace-nowrap gap-2">
